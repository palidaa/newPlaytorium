  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 col-md-offset-2">
        ...
        <hr>
        <div class="progress">
          <div class="progress-bar" role="progressbar" :style="{width: parseInt(totalTimesheets/workingDay*100) + '%'}">
        ...
        <!-- timesheet -->
        <div class="panel panel-default" :class="{ 'panel-danger': timesheet.isHoliday }" v-for="(timesheet, key) in timesheets">
          ...
          <div class="panel-body">
            <p>Date: @{{ timesheet.date }}, @{{ timesheet.dayOfWeek }} @{{ timesheet.holidayName }}</p>
